  ...
  return (
    <SafeAreaView className="flex-1 bg-arc-cream" edges={['top']}>
      ...
      <View className="w-full max-w-[880px] self-center gap-5">
        <Text className="font-serif-bold text-2xl text-stone-900">Crisis resources</Text>
        ...
        <Pressable
          className="max-w-[360px] rounded-lg border border-stone-300 bg-white px-4 py-3 active:opacity-80"
          accessibilityRole="button"
          onPress={() => Alert.alert('Call support', 'Wire hotline actions for your target region.')}
        >
          <Text className="font-sans-semibold text-sm text-stone-900">Contact support hotline</Text>
          <Text className="pt-0.5 font-sans text-xs text-stone-500">Tap to configure hotline action</Text>
        </Pressable>
      </View>
      </View>
    </SafeAreaView>
