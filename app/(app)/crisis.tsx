  ...
  return (
    <SafeAreaView className="flex-1 bg-zinc-50" edges={['top']}>
      ...
      <View className="w-full max-w-[880px] self-center gap-5">
        <Text className="font-serif-bold text-2xl text-zinc-900">Crisis resources</Text>
        ...
        <Pressable
          className="max-w-[360px] rounded-lg border border-zinc-300 bg-white px-4 py-3 active:opacity-80"
