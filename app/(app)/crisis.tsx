      ...
      <View className="flex-1 px-6 py-8">
        <View className="w-full max-w-[880px] gap-5 self-center">
          ...
          <Pressable
            ...
            onPress={() =>
              Alert.alert('Call support', 'Wire hotline actions for your target region.')
            }>
            <Text className="font-sans-semibold text-sm text-zinc-900">
              Contact support hotline
            </Text>
            <Text className="pt-0.5 font-sans text-xs text-zinc-500">
              Tap to configure hotline action
            </Text>
          </Pressable>
        </View>
      </View>
